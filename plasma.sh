...
kwriteconfig6 --file "kwinrc" --group "NightColor" --key "NightTemperature" "4400"
...
kwriteconfig6 --file "kwinrc" --group "org.kde.kdecoration2" --key "ButtonsOnRight" "F"
...
kwriteconfig6 --file "kwinrc" --group "Script-krohnkite" --key "floatingTitle" "Picture-in-Picture"
kwriteconfig6 --file "kwinrc" --group "Script-krohnkite" --key "preventMinimize" "false"
kwriteconfig6 --file "kwinrc" --group "Script-krohnkite" --key "screenGapBetween" "9"
kwriteconfig6 --file "kwinrc" --group "Script-krohnkite" --key "screenGapBottom" "9"
kwriteconfig6 --file "kwinrc" --group "Script-krohnkite" --key "screenGapLeft" "9"
kwriteconfig6 --file "kwinrc" --group "Script-krohnkite" --key "screenGapRight" "9"
kwriteconfig6 --file "kwinrc" --group "Script-krohnkite" --key "screenGapTop" "9"
kwriteconfig6 --file "kwinrc" --group "Effect-blurplus" --key "BlurStrength" "6"
kwriteconfig6 --file "kwinrc" --group "Effect-blurplus" --key "NoiseStrength" "3"
kwriteconfig6 --file "kwinrc" --group "Effect-blurplus" --key "WindowClasses" "org.wezfurlong.wezterm"
